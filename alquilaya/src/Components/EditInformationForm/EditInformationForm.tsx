...
const CompleteInformationForm = () => {
  ...
  const notifyLoginTrue = () => toast.success("Edición exitosa", { autoClose: 3000 });
  const notifyLoginFalse = () => toast.error("Ha ocurrido un error, vuelve a intentar", { autoClose: 3000 });
