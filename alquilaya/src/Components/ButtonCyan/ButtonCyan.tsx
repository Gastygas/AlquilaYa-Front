...
const ButtonCyan = () => {
    return (
        <button className="flex items-center justify-center border-2 border-[#aa31cf] bg-[#2CFFDE] text-black px-8 py-3 rounded-lg font-bold hover:scale-110 transition transform duration-200">
